...
public interface IDeviceManager {
	void addDevice(String name, X509Certificate deviceCert, DeviceType type)
			throws DeviceManagerException;

	void removeDevice(PanboxDevice device) throws DeviceManagerException;

	List<PanboxDevice> getDeviceList() throws DeviceManagerException;

	PanboxDevice getDevice(String name) throws DeviceManagerException;
