...
public class PairThisDeviceDialog extends javax.swing.JDialog implements
	...
	public PairThisDeviceDialog(java.awt.Frame parent) throws Exception {
		...
		try {
			...
			logger.warn(
					"PairThisDeviceDialog : Failed to load webcam. This might not be a problem. Thrown exception: ",
					e);
		}
	...
	private void initComponents(int deviceId) {
		...
		infoMessageLabel.setText(bundle
				.getString("client.setupwizard.pairing.message")); // NOI18N

		camLabel.setText(bundle
				.getString("client.setupwizard.pairing.camLabel")); // NOI18N
		...
		javax.swing.GroupLayout camLifeViewPanelLayout = new javax.swing.GroupLayout(
				camLifeViewPanel);
		...
		importFileButton.setText(bundle
				.getString("client.setupwizard.pairing.importFileLabel")); // NOI18N
		...
		enterPasswordButton.setText(bundle
				.getString("client.setupwizard.pairing.enterPasswordLabel")); // NOI18N
		enterPasswordButton
