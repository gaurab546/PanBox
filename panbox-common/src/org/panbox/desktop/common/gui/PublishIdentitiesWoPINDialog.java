...
public class PublishIdentitiesWoPINDialog extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		cancelButton.setText(bundle
				.getString("ExportIdentitiesDialog.cancelButton")); // NOI18N
		...
		publishButton.setText(bundle
				.getString("PublishIdentitiesDialog.publishButton")); // NOI18N
		...
		distributionLinkLabel.setText(bundle
				.getString("PublishIdentitiesDialog.distributionLinkLabel")); // NOI18N

		copyEmaiButton.setText(bundle
				.getString("PublishIdentitiesDialog.copyToEmailButton")); // NOI18N
		...
		copyClipBoardButton.setText(bundle
				.getString("PublishIdentitiesDialog.copyToClipBoardButton")); // NOI18N
	...
	private void copyEmaiButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_copyEmaiButtonActionPerformed
		if (Settings.getInstance().isMailtoSchemeSupported()) {
			DesktopApi.browse(URI.create("mailto:?to=&subject="
					+ bundle.getString("client.mailTo.importIdentitySubject")
					+ "&body=" + distributionLinkTextField.getText()));
			this.dispose();
		}
	...
	private void publishButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_publishButtonActionPerformed
		...
		try {
			...
			if (!vcardFile.canWrite()) {
				...
				distributionLinkTextField.setText(PanboxURICmdImportIdentity
						.getPanboxLink(ret).toString());
				copyClipBoardButton.setEnabled(true);
				copyEmaiButton.setEnabled(Settings.getInstance()
						.isMailtoSchemeSupported());
			}
		} catch (IOException | CSPApiException | CSPIOException e) {
			logger.error("PublishIdentityDialog : Could not publish identity.",
					e);
			JOptionPane
					.showMessageDialog(
							this,
							bundle.getString("PublishIdentitiesDialog.errorPublishing"),
