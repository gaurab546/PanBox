...
public abstract class VirtualRandomAccessFile extends VirtualFile implements IRandomAccess {

	protected VirtualRandomAccessFile(String fileName, VirtualVolume volume) {
